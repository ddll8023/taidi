...
class Task2Workspace(Base):
    __tablename__ = "task2_workspace"

    id = Column(Integer, primary_key=True, autoincrement=True, comment="工作台ID")
    source_file_name = Column(String(255), comment="附件4源文件名")
    source_file_path = Column(String(500), comment="附件4源文件路径")
    ...
    __table_args__ = (
        Index("idx_task2_workspace_status", "import_status"),
        Index("idx_task2_workspace_updated", "updated_at"),
    )

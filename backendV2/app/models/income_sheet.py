...
class IncomeSheet(Base):
    ...
    operating_expense_selling_expenses = Column[DECIMAL](
        DECIMAL(20, 2), comment="营业总支出-销售费用(万元)"
    )
    operating_expense_administrative_expenses = Column[DECIMAL](
        DECIMAL(20, 2), comment="营业总支出-管理费用(万元)"
    )
    operating_expense_financial_expenses = Column[DECIMAL](
        DECIMAL(20, 2), comment="营业总支出-财务费用(万元)"
    )
    operating_expense_rnd_expenses = Column[DECIMAL](
